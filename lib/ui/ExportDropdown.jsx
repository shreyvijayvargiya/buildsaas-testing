	...
	const renderButton = () => {
		return (
			<button
				...
				className={`flex items-center gap-1.5 p-1.5 text-xs font-medium bg-zinc-100 hover:bg-zinc-200 rounded-xl transition-colors disabled:opacity-50 disabled:cursor-not-allowed ${className}`}
			>
	...
	const renderOption = (option, index, isSelected) => {
		...
		return (
			<button
				...
				className={`w-full px-2.5 py-1.5 text-left flex items-center gap-2 transition-colors text-xs disabled:opacity-50 disabled:cursor-not-allowed ${
					isSelected
