	...
	return (
		<div className={`relative ${className}`} ref={datePickerRef}>
			<motion.button
				...
				className="w-full px-4 py-2 border border-zinc-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-zinc-900 bg-white flex items-center justify-between text-sm"
			>
