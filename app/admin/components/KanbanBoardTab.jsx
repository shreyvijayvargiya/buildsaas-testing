...
const KanbanBoardTab = ({ queryClient }) => {
	...
	return (
		<div className="min-h-full">
			{/* Header */}
			<div className="mb-6">
				<h2 className="text-2xl font-bold text-zinc-900 mb-4">Kanban Board</h2>
				<div className="flex items-center gap-1 mb-4 rounded-xl p-1.5 bg-zinc-50 w-fit">
					<motion.button
				...
				<div className="flex items-center gap-3">
					<div className="relative">
						...
						<input
							...
							className="pl-10 pr-4 py-2 border border-zinc-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-zinc-900 focus:border-transparent text-sm w-64"
						/>
					</div>
